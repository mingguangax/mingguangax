            ...
            <div class="box">
                ...
                <div style="margin: 10px;">
                    <form class="form-inline" id="searchForm" action="/employee/list" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="dept" name="deptId">
                                ...
                                <#list departments as department>
                                    <option value="${department.id}" ${(department.id==qo.deptId)?string('selected','')}>${department.name}</option>
                                </#list>
                            </select>
                        </div>
                        ...
                        <a href="/employee/exportXls" class="btn btn-warning btn-input">
                    ...
                    <#list pageInfo.list as employee>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/employee/delete?id=${employee.id}" class="btn btn-danger btn-xs btn-delete">
