            ...
            <div class="box">
                    ...
                    <form class="form-inline" id="searchForm" action="/consumptionReport/list" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-daterange input-group" >
                                <input type="text" name="beginCreateTime" value="${(qo.beginCreateTime?string('yyyy-MM-dd'))!}" class="input-sm form-control input-data"/>
                                <span class="input-group-addon">到</span>
                                <input type="text" name="endCreateTime" value="${(qo.endCreateTime?string('yyyy-MM-dd'))!}" class="input-sm form-control input-data"/>
                            </div>
                        </div>
                        <script>
                ...
                <div class="box-body table-responsive no-padding ">
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            <#list pageInfo.list as cr>
                                <tr>
                                    <td>${cr.groupType}</td>
                                    <td>${cr.totalCount}</td>
                                    <td>${cr.totalAmount}</td>
                                    <td>${cr.totalPayAmount}</td>
                                    <td>${cr.totalDiscountAmount}</td>
                                </tr>
                            </#list>
                        </tbody>
